...
#define CTL_SHORTNAME 5 /* max sysctl(2) name length that fits in message */
...
typedef struct {
	...
	int uts_type;		/* 0:sethostname,gethostname; 1:fork,vfork,clone without newuts; 2:clone; -1:delete uts process*/
} mess_lc_mib_sysctl;
